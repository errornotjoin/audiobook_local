...
<body>
    ...
    if($Json_Audiobook_file == null)
    {
        ...
        echo "<div class='chapters_and_add_more'>";
            echo "<div>";
            echo "<a class='items' href='add_time_stamps.php?book_id=".$ID_Code ."' style='display: grid; grid-template-columns:  30% 30% 30% ; color:inherit; position: relative; left: 0%;'>";
            echo "<h2></h2>";
        ...
        echo "</div>";
         ...
         echo "<div class='chapters_and_add_more' style='position: relative; top:180px;' >";
            ...
            echo "<button onclick='window.location.href=\"serverside/Remove_history.php?bookID=".$_GET["book"]."\"'>Clear History</button>";
